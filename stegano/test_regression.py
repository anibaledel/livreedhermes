...
_K360  = _keys_from_master(KEY_KNOWN,  'carter360')
...
class TestFixtures(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        grid3 = make_fixture(encode_carter_360, MSG_SHORT, CK360_KNOWN, GK360_KNOWN, ref360_v3,
    ...
    def test_carter_360_decode_stable(self):
        ...
        gk = bytes.fromhex(f['gk'])
        self.assertEqual(
            decode_carter_360(csv_to_grid(f['grid']), ck, gk, ref360_v3),
...
class TestEndToEnd(unittest.TestCase):
    ...
    def test_carter_360_roundtrip(self):
        # Carter-360 (format v4, deux clés) ne passe plus par _roundtrip
        # (générique à clé unique) -- voir test_carter_256_roundtrip.
        grid = encode_carter_360(MSG_LONG, CK360_KNOWN, GK360_KNOWN, self.ref360_v3)
    ...
    def test_key_isolation(self):
        ...
        grid360 = encode_carter_360(MSG_SHORT, CK360_KNOWN, GK360_KNOWN, self.ref360_v3)
        self.assertEqual(decode_carter(grid256, CK_KNOWN, GK_KNOWN, self.ref256_v3), MSG_SHORT)
        self.assertEqual(decode_carter_360(grid360, CK360_KNOWN, GK360_KNOWN, self.ref360_v3), MSG_SHORT)
